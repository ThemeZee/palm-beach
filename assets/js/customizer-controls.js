	...
	wp.customize( 'custom_logo', function( setting ) {
		setting.bind( function( value ) { 
			if ( '' !== value ) {
				...
				wp.customize.instance( 'palm_beach_theme_options[retina_logo]' ).set( false );
			}
		});
		...
		wp.customize.control( 'palm_beach_theme_options[retina_logo_title]', setupControl );
		wp.customize.control( 'palm_beach_theme_options[retina_logo]', setupControl );
	} );
