...
function palm_beach_theme_info_menu_link() {
	...
	add_theme_page(
		sprintf( esc_html__( 'Welcome to %1$s %2$s', 'palm-beach' ), $theme->display( 'Name' ), $theme->display( 'Version' ) ),
...
function palm_beach_theme_info_page() {
	...
	<div class="wrap theme-info-wrap">
		...
		<h1><?php printf( esc_html__( 'Welcome to %1$s %2$s', 'palm-beach' ), $theme->display( 'Name' ), $theme->display( 'Version' ) ); ?></h1>
		...
		<div id="getting-started">
			...
			<h3><?php printf( esc_html__( 'Getting Started with %s', 'palm-beach' ), $theme->display( 'Name' ) ); ?></h3>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p class="about">
							<?php printf( esc_html__( '%s makes use of the Customizer for all theme settings. Click on "Customize Theme" to open the Customizer now.', 'palm-beach' ), $theme->display( 'Name' ) ); ?>
						</p>
						<p>
...
function palm_beach_theme_info_page_css( $hook ) {
	...
	wp_enqueue_style( 'palm-beach-theme-info-css', get_template_directory_uri() . '/assets/css/theme-info.css' );
